...
namespace RWBYRemnant
{
    public class Pawn_Grimm : Pawn
    {
        ...
        public override void Tick()
        {
            ...
            if (Downed)
            {
                if (lastTakenDamageFrom is Pawn killer && killer.RaceProps.Humanlike && killer.story.traits.HasTrait(RWBYDefOf.Semblance_Weiss) && killer.TryGetComp<CompAbilitiesAura>() is CompAbilitiesAura compAbilityUserAura && compAbilityUserAura.IsInitialized)
                {
