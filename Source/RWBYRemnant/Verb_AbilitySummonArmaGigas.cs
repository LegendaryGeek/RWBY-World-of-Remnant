        ...
        protected override bool TryCastShot()
        {
            ...
            else
            {
                for (int i = 0; i < this.TargetsAoE.Count; i++)
                {
                    ...
                    CasterPawn.TryGetComp<CompAbilitiesAura>().AbilityData.AllPowers.Find(a => a.Def == RWBYDefOf.Weiss_SummonArmaGigas).CooldownTicksLeft = 3600;
                    CasterPawn.TryGetComp<CompAbilitiesAura>().AbilityData.AllPowers.Find(a => a.Def == RWBYDefOf.Weiss_SummonArmaGigasSword).CooldownTicksLeft = 3600;
